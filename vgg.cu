              ...
              int pad_w, int pad_h, int wstride, int hstride)
{
    ...
    // fwd conv
    auto code2 = cudnnConvolutionBiasActivationForward(cudnn_handle,&alpha,x_desc.desc,x_desc.data,w_desc.desc,w_desc.data,conv_desc,fwd_algo,fwd_workspace.data,fwd_workspace_size,&beta,h_desc.desc,h_desc.data,bias.desc,bias.data,activationDesc,
                                                       h_desc.desc,
                                                       h_desc.data);
